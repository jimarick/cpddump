...
<head>
    ...
    <title>Marked as done — CPD Dump</title>
    <style>
...
<body>
    <div class="card">
        <h1>Got it — {{ $marked }} {{ Str::plural('takeaway', $marked) }} marked as done.</h1>
        <p>
            They won't be resurfaced in digests or the morning gem.
            Changed your mind? Restore any of them on
            <a href="{{ route('takeaways') }}">your Takeaways page</a>.
        </p>
    </div>
</body>
</html>
