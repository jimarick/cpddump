...
/**
 * Companion-app mirror of the web merge flow — same service, same
 * validation errors, JSON envelopes instead of redirects.
 */
class MergeApiController extends Controller
{
    ...
    public function unmerge(Request $request, Activity $activity, ActivityMerger $merger): JsonResponse
    {
        ...
        return response()->json([
            'activity_ids' => $released->pluck('id')->values()->all(),
        ]);
    }
}
