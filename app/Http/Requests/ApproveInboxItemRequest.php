...
class ApproveInboxItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nuggets' => ['nullable', 'array', 'max:15'],
            'nuggets.*.id' => ['required', 'string', 'max:40'],
            'nuggets.*.text' => ['required', 'string', 'max:500'],
            'nuggets.*.done' => ['nullable', 'boolean'],
            'actions' => ['nullable', 'array', 'max:15'],
            'actions.*.id' => ['required', 'string', 'max:40'],
            'actions.*.text' => ['required', 'string', 'max:500'],
